...
- vundle是vim的一个插件管理器,使用它可以方便的安装管理vim的各种插件,下面是它的github地址,下面是安装流程(具体以github上的说明为主):
...
YouCompleteMe插件用来自动补全代码，但是使用vim打开文件时候提示*The ycmd server SHUT DOWN (restart with ...low the instructions in the documentation.*
