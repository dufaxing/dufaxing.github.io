...
categories: 工具
tags: HTML
excerpt: 根据网上开源项目整合，零依赖纯前端工具，无需安装任何软件，打开浏览器即可使用
mathjax: true
---
* content
{:toc}
...
本工具只需要将下列`todo_list.html` 跟`manifest.json`保存在本地并放在同一目录下，然后浏览器打开todo_list.html即可<br>

[![pVckrQg.jpg](https://s21.ax1x.com/2025/08/30/pVckrQg.jpg)](https://imgse.com/i/pVckrQg)
